...
const footerLinks = {
  ...
  "Contact": [
    { label: "neofuture@slrtce.in", href: "mailto:neofuture@slrtce.in", icon: <Mail className="w-3.5 h-3.5" /> },
    { label: "+91 98765 43210", href: "tel:+919876543210", icon: <Phone className="w-3.5 h-3.5" /> },
